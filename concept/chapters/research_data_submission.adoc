...
[#_forschungsdaten]
=== Verarbeitung von Daten der elektronischen Patientenakten zu Forschungszwecken
...
image::Feature-Research-Submission.png[caption="Abbildung {counter:figure}: ", reftext="Abbildung {figure}", title="Research Data Submission - Beteiligte Komponenten",width=100%, pdfwidth=100%,float="center",align="center",title-align="center"]
...
[#fig:research-submission]
[plantuml, "{diagramsdir}/researchsubmission", svg]
[caption="Abbildung {counter:figure}: ", reftext="Abbildung {figure}", title="Ablauf der Übermittlung von Forschungsdaten",width=100%, pdfwidth=100%,float="center",align="center",title-align="center"]
....
include::{chapterplantumlsdir}/researchsubmission.puml[]
....
...
image::plantuml/researchsubmission.svg[caption="Abbildung {counter:figure}: ", reftext="Abbildung {figure}", title="Ablauf der Übermittlung von Forschungsdaten",width=100%, pdfwidth=100%,float="center",align="center",title-align="center"]
...
Versicherte oder vom Versicherten befugte Vertreter können unter Nutzung eines ePA-FdVs jederzeit bestimmten Zwecken nach § 303e Absatz 2 SGB V widersprechen. Diese Widersprüche können mitels ePA-FdV jederzeit wieder zurückgenommen werden.
...
Die aktuellen Widersprüche eines Versicherten werden in dessen Aktenkonto im Widerspruchsmanagmenet (Consent Management) gespeichert und können darüber verwaltet werden. Neben dem Widerspruch gegen die Übermittlung insgesamt, müssen auch die einzelnen Zwecke nach § 303e Absatz 2 SGB V über das Widerspruchsmangement verwaltbar sein.
...
|Widerspruch gegen einzelne Zwecke nach § 303e Absatz 2 SGB V bzw. deren Rücknahme
|Das ePA-Aktensystem übermittelt die Änderungen bei den Widersprüchen zu den Zwecken nach § 303e Absatz 2 SGB V an das FDZ. Das ePA-Aktensystem übermittelt weiterhin unverändert Daten an das FDZ. Die vom Versicherten geäußerte Änderung der Zweckbeschränkung ist vom FDZ durchzusetzen.
...
Forschungszwecken. Test- und Referenzobjekte seitens FDZ und VST werden daher in der TU nicht benötigt.

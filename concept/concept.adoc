...
include::chapters/research_data_submission.adoc[]
...
link:./chapters/research_data_submission.adoc[Datenübermittlung an das FDZ (Research Data Submission)]
endif::[]
...
link:https://github.com/gematik/ePA-XDS-Document/tree/ePA-3.1.0/concept[Dokumentenmanagement (XDS Document Service)]
...
link:https://github.com/gematik/ePA-Medication/tree/ePA-3.1.0/concept[Medikationsprozess (Medication Service)]
